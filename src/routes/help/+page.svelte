<main>
	<div class="min-w-full flex flex-col items-center gap-8 p-8
		...
		<h2 class="px-8 py-2 w-full text-center text-transparent bg-clip-text bg-gradient-to-r from-secondary to-primary
							md:px-12
							lg:px-36">
		...
		<div class="flex flex-col items-center gap-8
			...
			<iframe title="Discord" height="500" width="350"
